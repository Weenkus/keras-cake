...
def _dropout(x, level, noise_shape=None, seed=None):
    ...
    x *= 1.0 - level  # compensate for the scaling by the dropout
    return x
...
class QRNN(Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.recurrent_dropout = (
            0
        )  # not used, added to maintain compatibility with keras.Bidirectional
    ...
    def reset_states(self, states=None):
        ...
        if not batch_size:
            raise ValueError(
                "If a QRNN is stateful, it needs to know "
    ...
    def preprocess_input(self, inputs, training=None):
        ...
        if self.dropout is not None and 0.0 < self.dropout < 1.0:
            ...
            f = K.in_train_phase(
                1 - _dropout(1 - f, self.dropout), f, training=training
            )
    ...
    def step(self, inputs, states):
        ...
        z = self.activation(z)
        f = f if self.dropout is not None and 0.0 < self.dropout < 1.0 else K.sigmoid(f)
        o = K.sigmoid(o)
